...
def four_R_reliability_computation(r1, r2, r3,r4):
    reliability_list = [r1*r2*r3*r4,(1-r1)*r2*r3*r4,(1-r2)*r1*r3*r4,(1-r3)*r1*r2*r4,(1-r4)*r1*r2*r3,
                        (1-r1)*(1-r2)*r3*r4,(1-r1)*(1-r3)*r2*r4,(1-r1)*(1-r4)*r3*r2,(1-r2)*(1-r3)*r1*r4,(1-r2)*(1-r4)*r3*r1,(1-r3)*(1-r4)*r1*r2
                        ]
    conditional_reliability_list = []
    for p in reliability_list:
        conditional_reliability_list.append(
            p / np.sum(reliability_list))

    # conditional_reliability_list.append(r1 * r2 * r3/(r1 * r2 + r1 * r3 + r2 * r3 - 2 * r1 * r2 * r3))
...
all_reliabilities.append(cr_list[0]+cr_list[2]+cr_list[3]+cr_list[8]) #23
all_reliabilities.append(cr_list[0]+cr_list[2]+cr_list[4]+cr_list[9]) #24
all_reliabilities.append(cr_list[0]+cr_list[3]+cr_list[4]+cr_list[10]) #34
all_reliabilities.append(cr_list[0]+cr_list[1]+cr_list[2]+cr_list[3]+cr_list[5]+cr_list[6]+cr_list[8]) #123
all_reliabilities.append(cr_list[0]+cr_list[1]+cr_list[2]+cr_list[4]+cr_list[5]+cr_list[7]+cr_list[9]) #124
all_reliabilities.append(cr_list[0]+cr_list[1]+cr_list[3]+cr_list[4]+cr_list[6]+cr_list[7]+cr_list[10]) #134
all_reliabilities.append(cr_list[0]+cr_list[2]+cr_list[3]+cr_list[4]+cr_list[8]+cr_list[9]+cr_list[10]) #234
